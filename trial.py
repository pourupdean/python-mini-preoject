...
radius_entry=Entry(area_frame,font=("Calibri",20))
radius_entry.pack()

height=Label(area_frame,text="Enter height or width in m if applicable else enter 0").pack()
height_entry=Entry(area_frame,font=("Calibri",20))
height_entry.pack()
...
radius_entry2=Entry(volume_frame,font=("Calibri",20))
radius_entry2.pack()
height2=Label(volume_frame,text="Enter height in m if applicable else enter 0").pack()
height2=Entry(volume_frame,font=("Calibri",20))
height2.pack()
width=Label(volume_frame,text="Enter breadth in m if applicable else enter 0").pack()
width_entry=Entry(volume_frame,font=("Calibri",20))
width_entry.pack()

#condition frame
condition_options=OptionMenu(condition_frame,conditions,"Pythagorean Triplet Checker","Complimentary&Supplementary Angles").pack()
mybutton3=Button(condition_frame,text="Select condition",command=show3).pack()
side1_label=Label(condition_frame,text="Enter first number").pack()
side1_entry=Entry(condition_frame,font=("Calibri",20))
side1_entry.pack()
side2_label=Label(condition_frame,text="Enter second number").pack()
side2_entry=Entry(condition_frame,font=("Calibri",20))
side2_entry.pack()
side3_label=Label(condition_frame,text="Enter third number").pack()
side3_entry=Entry(condition_frame,font=("Calibri",20))
side3_entry.pack()
angle_label=Label(condition_frame,text="Enter angle in degrees").pack()
angle_entry=Entry(condition_frame,font=("Calibri",20))
angle_entry.pack()
